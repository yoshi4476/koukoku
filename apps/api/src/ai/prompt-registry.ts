...
# 除外キーワード (negatives)
発注意思のない検索を必ず挙げる。求人・自分で・やり方・中古・苦情など、その商材で無駄クリックになる語を具体的に。15〜30語。
**重要**: 単独の広い語 (「無料」など) を除外に入れてはいけない。<brief> のオファーが「無料相談」「無料診断」の場合、
最も成約に近いキーワードを自分で塞いでしまう。除外は「無料ツール」「自分で やり方」のように、
発注意思がないことが明確な**複合語**にすること。keywords に出した語と重なる除外語は絶対に出さない。
